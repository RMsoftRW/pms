...
if (isset($_POST['save1'])) {
    ...
    $dob = $database->escape_value($_POST['dob']);
...
if (isset($_POST['save2'])){
    ...
    $sql = "INSERT INTO add_info_amb(request_date,arrival,departure,presentation_date,id_ambassador) VALUES ('$request_date','$arrival','$departure','$cred',$ambassador)";
    if ($database->query($sql)) {
