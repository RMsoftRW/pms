            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-content-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="contact_phone" placeholder="Enter Contact Person Phone Number" minlength="4" name="contact_phone" value="<?=check_if('contact_phone');?>">
                  </div>
                  <div class="form-group">
