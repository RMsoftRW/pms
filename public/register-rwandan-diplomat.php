    ...
    <div class="container">
        <div class="tab-container">
            <div class="tab-content" id="nav-tabContent">
                <div id="nav-tab">
                    <ul>
                        <li id="active"><a href="<?=$_SERVER['REQUEST_URI']?>">Rwandan Diplomats</a></li>
                    </ul>
                </div>
                <div class="tab-content-body">
                    <legend>Registration Form  for Rwandan Diplomats</legend>
                    <form action="save-rwandan-diplomats.php" method="POST" id="form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="country5" name="father_nat">
                                <?php $st2 = $database->query("SELECT * FROM countries");
                                foreach ($st2 as $key => $value) {?>
                                    <option id="option" value="<?=$value['id']?>"><?=$value['name']?></option><?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="country6" name="mother_nat">
                                <?php $st2 = $database->query("SELECT * FROM countries");
                                foreach ($st2 as $key => $value) {?>
                                    <option id="option" value="<?=$value['id']?>"><?=$value['name']?></option><?php } ?>
                            </select>
