...
<body>
    ...
    #header-h2{color: #272C33}
    .btn .btn-primary .update{background: #272C33}
    #btn{background: #272C33;border: none}
    </style>
    <style type="text/css">
        body {
            color: #566787;
            ...
            <div class="block-header text-center" style="position: relative;top: 20px;margin-right: 10%;">
                <h2 id="header-h2">
                    ...
                    <div class="pull-right" style="margin-bottom: 20px;">
                        ...
                        <input class="form-control pull-right" placeholder="Search ... " maxlength="20" id="search" aria-label="Search" type="text" name="search" data-id="<?=$Hash->decrypt($_GET['id'])?>" autocomplete="off" style="border: none;border-bottom: 1px solid #095C7E;background: transparent;box-shadow: none;color: #095C7E">
                        </form>
                        </div>
                    </form>
                    </div>
